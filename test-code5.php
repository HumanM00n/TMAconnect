...
try {
    ...
    // ********* PERMET DE RECUPERER LA PREMIERE LETTRE DU NOM ET DU PRENOM *********
    $nom = $result['nom'];
                ...
                <ul>
                    ...
                    <li class="Onglet"><a href="#" class="deroulant">Demandes ▼</a>
                        <ul class="sous">
                            ...
                            <li><a href="<?php echo $dirPages; ?>#" >Gestion des stocks</a></li>
                        </ul>
                    </li>
                    <li class="Onglet"><a href="<?php echo $dirPages; ?>user/Utilisateurs.php">Utilisateurs</a></li>

                    <li class="Onglet"><a href="<?php echo $dirPages; ?>#">Gestion TMA</a></li>
                    ...
                    <li class="MonCompte"><a href="#">
                        ...
                        <ul class="sous2">
                        <li><a href="<?php echo $dirPages; ?>#">Paramètres</a></li>
